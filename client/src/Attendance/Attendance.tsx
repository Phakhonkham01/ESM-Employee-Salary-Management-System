                        ...
                        {showAddForm && (
                            <div className="bg-blue-50 p-6 rounded-lg mb-6">
                                <h3 className="text-xl font-semibold mb-4">
                                    {editingId ? 'ແກ້ໄຂຂໍ້ມູນ / Edit Employee' : 'ເພີ່ມພະນັກງານໃໝ່ / Add New Employee'}
                                </h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <input
                                        type="text"
                                        placeholder="ຊື່ພະນັກງານ / Name"
                                        value={formData.name}
                                    ...
                                    <input
                                        type="number"
                                        placeholder="ເງິນເດືອນພື້ນຖານ / Base Salary (LAK)"
                                    ...
                                    <input
                                        type="number"
                                        placeholder="ອັດຕາ OT ຕໍ່ຊົ່ວໂມງ / OT Rate/Hour (LAK)"
                                    ...
                                    <input
                                        type="number"
                                        placeholder="ຊົ່ວໂມງ OT / OT Hours"
                                    ...
                                    <input
                                        type="number"
                                        placeholder="ວັນຂາດງານ / Absent Days"
                                    ...
                                    <input
                                        type="number"
                                        placeholder="ວັນລາພັກ / Leave Days"
